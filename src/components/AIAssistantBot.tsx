...
export default function AIAssistantBot({ userProfile }: AIAssistantBotProps) {
  ...
  const [messages, setMessages] = useState<ChatMessage[]>([{
    id: 'welcome-msg',
    role: 'assistant',
    content: "Hi! I'm your Campus OS AI Assistant. How can I help you today?",
    timestamp: new Date()
  }]);
            ...
            <div className="flex items-center justify-between p-4 border-b border-slate-100 dark:border-slate-800 bg-brand-primary/5">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-[10px] text-slate-500 dark:text-slate-400 font-medium">Campus OS Helper • Online</p>
                </div>
              </div>
